...
const String authCode = "AQA7YNqJbbK91WLv_3NV7unx3xNpeDgmCwEQYppaT9qk6os-j90aquuW_BNoPWbGG3GLAj7Sbkc21QadedXTN3HTffGtK_di3mNPAqCbm1ouNKoctxzlFLR5vqY7drwDo9rTgMbwzfe10cuwnzCWa0hZAbYY_5fPPJ93qZs";
...
void setup() {
  ...
  WiFi.mode(WIFI_STA);
  WiFiUtilities wifi("The Force", "thisistheway");
  wifi.connectToWiFi();
